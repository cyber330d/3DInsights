    ...
    <div className="flex flex-col w-full items-center justify-center gap-8 max-md:py-12 px-4 md:px-4">
      <div className="flex items-center justify-between gap-8 ">
        ...
        <div className="flex flex-col items-start justify-center w-1/2 gap-2 sm:gap-4 md:p-8">
          <h3 className="text-base text-center md:text-xl font-semibold  leading-5 md:leading-7">
            Become an Instructor
          </h3>
          <p className="text-[10px] md:text-base md:leading-6 px text-center-3">
          ...
          <LinkComponent
            ...
            className="ring-1 ring-lms-green rounded-lg   md:px-4 md:py-2 mx-0 font-normal md:leading-5 text-[10px] px-2 py-0.5 text-center md:text-sm"
          />
        </div>
      </div>
      <div className="flex items-center justify-between gap-8 ">
