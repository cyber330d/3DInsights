  ...
  return (
    <div className="flex flex-col items-center justify-center self-stretch gap-12 py-10 shadow  bg-green-100  w-full">
      <div className="flex flex-col items-center justify-center gap-4 text-3xl  leading-10 p-6 ">
        ...
        <p className="text-base font-normal leading-normal text-center text-neutral-700 ">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod temporidunt ut labore veniam
        </p>
      </div>
      <div className=" course-container flex items-center justify-center gap-20 flex-wrap">
