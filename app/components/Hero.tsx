...
export default function Hero(props: { className?: string | undefined }) {
  return (
    <div className="w-full h-screen relative flex items-start smjustify-between">
      <div
        ...
        bottom-0 w-full sm:w-4/5 sm:bottom-[8%] md:bottom-[30%] md:w-4/6 lg:w-2/5"
      >
        ...
        <div className="self-center max-w-80 ">
          <LinkComponent
            to="/register"
            label="Get Started"
            className="!text-white w-52 rounded-lg bg-lms-green hover:bg-green-700 flex flex-row items-center justify-center box-border text-xs p-3  "
          />
        </div>
      </div>

      <div className=" w-full h-[60vh] sm:h-full -top-0.5 absolute  bottom-0 left-0 right0  ">
        <Image
          src="/h71.png"
          width="1280"
          height="1280"
